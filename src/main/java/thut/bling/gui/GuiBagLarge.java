...
public class GuiBagLarge extends GuiContainer
{

    String            page;
    ContainerBagLarge cont;
    ...
    public GuiBagLarge(ContainerBagLarge cont)
    {
        super(cont);
        this.cont = cont;
        this.xSize = 175;
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int i, int j)
    {
        ...
        mc.renderEngine.bindTexture(new ResourceLocation(ThutBling.MODID, "textures/gui/large_bag.png"));
        int x = (width - xSize) / 2;
        ...
        for (int i = 0; i < 54; i++)
            if (!textFieldSearch.getText().isEmpty())
            {
                        ...
                        .contains(textFieldSearch.getText().toLowerCase(java.util.Locale.ENGLISH)))
                {
                    ...
                    mc.renderEngine.bindTexture(new ResourceLocation(ThutBling.MODID, "textures/hologram.png"));
    ...
    protected void keyTyped(char par1, int par2)
    {
        ...
        if (par2 == 28)
        {
            ...
            number = Math.max(1, Math.min(number, InventoryLarge.PAGECOUNT));
